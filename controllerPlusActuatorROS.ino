...
float g_suctionAngleCmd = 90;

void suctionAngleCmdCB(const std_msgs::Float32& msg){
  g_suctionAngleCmd = msg.data;
  g_moveAngle = true;
}
ros::Subscriber<std_msgs::Float32> suctionAngleCmdSub("suctionAngleCmd", suctionAngleCmdCB);
//end actuator setup
...
void suctionAngleMove(float cmd){
...
*/
  ...
  while (abs(suctionAngleSense-desiredSense)>5){
