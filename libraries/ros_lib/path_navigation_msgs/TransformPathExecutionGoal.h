#ifndef _ROS_path_navigation_msgs_TransformPathExecutionGoal_h
#define _ROS_path_navigation_msgs_TransformPathExecutionGoal_h
...
namespace path_navigation_msgs
{
  ...
  class TransformPathExecutionGoal : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "path_navigation_msgs/TransformPathExecutionGoal"; };
